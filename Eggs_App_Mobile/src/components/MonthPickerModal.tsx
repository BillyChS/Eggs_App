...
const makeStyles = (theme: Theme) => StyleSheet.create({
    ...
    yearArrow: { padding: 8 },
    yearArrowText: { fontSize: 24, color: theme.primary, fontWeight: '700' },
    yearLabel: { flex: 1, textAlign: 'center', fontSize: 18, fontWeight: '600', color: theme.textPrimary },
    closeBtn: { padding: 8 },
    closeText: { fontSize: 16, color: theme.textMuted, fontWeight: '600' },
    ...
    monthText: { fontSize: 14, fontWeight: '500', color: theme.textPrimary },
